...
GROQ_KEY = _get_key("GROQ_KEY", "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")
INFRACOST_KEY = _get_key("INFRACOST_KEY", "ico-LmfKm1skusYHLRV8tknBH67tx2Ti3vZw")
# ============================================================
